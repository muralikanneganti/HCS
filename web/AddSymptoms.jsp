                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name='age_group[]' id='age_group' class='form-control'>
                                                            ...
                                                            <option value='junior&adole'>Junior & Adolescent(6-16) years</option>
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#add").on('click', function(e) {
            ...
            var data = "<tr><td><span id='snum" + i + "'>" + count + ".</span></td><td><select name='age_group[]' id='age_group' class='form-control'><option selected='' disabled='' value=''>Select Age Group</option><option value='kid'>Kid(0-5) years</option><option value='senior&adole'>Senior & Adolescent(6-16) years</option><option value='young&adult'>Young Adult(17-29) years</option><option value='adult'>Adult(30-64) years</option><option value='senior'>Senior(65+) years</option></select</td>\n\
<td><select name='gender[]' id='gender' class='form-control'><option selected='' disabled=''>Select Gender</option><option value='Male'>Male</option><option value='Female'>Female</option></select></td>\n\\n\
