...
<body style="background-image: url(images/bg1.jpg);">
    ...
    %>
<center><h2>User's Feedback's</h2></center>
    <%
...
<table id="myTable" class="table table-striped" >
    ...
    <tbody>
        ...
        <tr><td><%=id%></td><td><%=s1%></td><td><%=s2%></td><td><%=s3%></td><td><%=s4%></td><td><%=s5%></td><td><%=s6%></td><td><%=s7%></td><td><a href="DeleteFeedBack?id=<%=rs.getInt("id")%>">Delete</a></td></tr>
        <%
                }
            } catch (Exception e) {
                out.println(e);
