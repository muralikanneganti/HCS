...
<table id="myTable" class="table table-striped" style="background-color: transparent;">
    <thead>
        <tr>
            <th>Sr. No.</th><th>Name</th><th>Email</th><th>Gender</th><th>Age</th><th>Fees</th><th>Department</th><th>Degree</th>
        </tr>
    </thead>
    <tbody>
        <%            try {
        ...
        <tr><td><%=count%><td><%=rs.getString("dname")%></td><td><%=rs.getString("email")%></td><td><%=rs.getString("gender")%></td><td><%=rs.getString("age")%></td><td><%=s6%></td><td><%=s7%></td><td><%=s8%></td>
