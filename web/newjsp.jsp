                                    ...
                                    <form action="FeedbackReg.jsp" method="post" role="form" class="contactForm lead">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-6 col-sm-6 col-md-6">
                                                <div class="form-group">
                                                    <label>Preferred Hospital Location</label>
                                                    <input type="text" name="hloc" required="" id="first_name" class="form-control input-md" title="Enter Contact No.">
                                                    <div class="validation"></div>
                                                </div>
                                            </div>
                                            <div class="col-xs-6 col-sm-6 col-md-6">
                                                <div class="form-group">
                                                    <label>Feedback</label>
                                                    <textarea  required rows="3" required="" class="form-control" cols="45" name="feedback"></textarea>
                                                    <div class="validation"></div>
                                                </div>
                                            </div>
                                    ...
                                    <form action="FeedbackReg.jsp" method="post" role="form" class="contactForm lead">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-6 col-sm-6 col-md-6">
                                                <div class="form-group">
                                                    <label>Preferred Hospital Location</label>
                                                    <input type="text" required="" name="hloc" id="first_name" class="form-control input-md" title="Enter Contact No.">
                                                    <div class="validation"></div>
                                                </div>
                                            </div>
                                            <div class="col-xs-6 col-sm-6 col-md-6">
                                                <div class="form-group">
                                                    <label>Feedback</label>
                                                    <textarea  required="" rows="3"  class="form-control" cols="45" name="feedback"></textarea>
                                                    <div class="validation"></div>
                                                </div>
                                            </div>
