...
<body id="page-top" data-spy="scroll" data-target=".navbar-custom" style="background:url('images/bg1.jpg') repeat left top;">
    ...
    <%
        ...
        if (pid != null) {
    %>
<center><h2>Queries of <%=pname%> [<%=pid%>] &nbsp;<a href="AskDoctor.jsp">Ask Query</a></h2></center>
    <%
...
<table id="myTable" class="table table-striped" style="background-color: transparent;">
    <thead>
        <tr>
            <th>Sr. No.</th><th>Your Query</th><th>Smoking</th><th>Alcohlic</th><th>Doctor Name</th><th>Department</th><th>Doctor Reply</th><th>Date</th>
        </tr>
    </thead>
    <tbody>
        <%
